...
class App extends Component {
  ...
  addPost = event => {
    ...
    fetch("http://localhost:8000/api/boastroast/", {
      ...
      body: JSON.stringify({
        message: event.target.children[1].control.value,
        boast_or_roast: event.target.children[0].control.checked
      })
    });
              ...
              : <div>{this.state.filter === 3 ? 
                <div>
                  <form>
                    ...
                    <input type="radio" value={this.state.boast_or_roast}onChange={this.handleInputChange}></input>
